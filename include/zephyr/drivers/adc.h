 ...
 * the "io-channels" and "io-channel-names" properties defined.
 *
 * Example devicetree fragment:
 *
 * @code{.dts}
 ...
 *     zephyr,user {
 *         io-channels = <&adc0 1>, <&adc0 3>;
 *         io-channel-names = "temperature", "barometer";
 *     };
 * };
 *
 * &adc0 {
 ...
 * static const struct adc_dt_spec adc_chan1 =
 *     ADC_DT_SPEC_GET_BY_IDX(DT_PATH(zephyr_user), "barometer");
 *
 * // Initializes 'adc_chan0' to:
 * // {
 * //     .dev = DEVICE_DT_GET(DT_NODELABEL(adc0)),
 ...
 *
 * @param node_id Devicetree node identifier.
 * @param name Channel name without quotes.
 *
 * @return Static initializer for an adc_dt_spec structure.
 */
